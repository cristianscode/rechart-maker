    ...
    return (
        <div>
            <p>
                ...
                {(props.type.toLowerCase() === "vertical" || props.type.toLowerCase() === "bar" || props.type.toLowerCase() === "horizontal") &&
                    <span>&emsp;&emsp;&emsp;&emsp;{"label: '" + props.state.datasets[0].label + "',"} <br /></span>
                }
            ...
            {(props.options.title.display && ((props.type.toLowerCase() === "pie" || props.type.toLowerCase() === "doughnut"))) &&
                <p>
                    {"const options = {"}<br />
                            &emsp;&emsp;{"title: {"} <br />
            ...
            <p style={{color: "#fca311"}}>{<GetChartText type={props.type.toLowerCase()} />}</p>
        </div>
    )
}
